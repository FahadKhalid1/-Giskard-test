...
5. Once it is running in the back ground double click and open the webApp.

you will see something like this:
![Web interface](resources/image.png)

Upload files millennium-falcon.json and empire.json from the Example of your choice.

Note: Please make sure the backend python is running the background.
